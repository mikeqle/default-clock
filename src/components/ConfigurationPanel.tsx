            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) => handleInputChange('longTermInterestRate', e.target.value)}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) => handleInputChange('receiptsGrowthRate', e.target.value)}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) => handleInputChange('expensesGrowthRate', e.target.value)}
          ...
          <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-600/30">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                ...
                <div className="text-cyan-300/60 text-xs font-mono">Interest Rate</div>
              </div>
              <div>
                <div className="text-green-400 font-mono text-lg font-bold">
                  {config.receiptsGrowthRate}%
                </div>
                <div className="text-green-300/60 text-xs font-mono">Receipts Growth</div>
              </div>
              <div>
                <div className="text-red-400 font-mono text-lg font-bold">
                  {config.expensesGrowthRate}%
                </div>
                <div className="text-red-300/60 text-xs font-mono">Expenses Growth</div>
              </div>
            </div>
          </div>
      </CardContent>
