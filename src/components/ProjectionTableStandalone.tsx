    ...
    <Card className="bg-gray-900/95 border-purple-500/50 backdrop-blur-sm shadow-lg">
      <CardHeader>
        ...
        <p className="text-purple-300/60 font-mono text-sm">
          Year-by-year breakdown of projected government finances until
          bankruptcy
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-mono">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-blue-300">
                Projected Interest Rate: {projectionConfig.longTermInterestRate}
                %
              </span>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-green-300">
                Receipts Growth: {projectionConfig.receiptsGrowthRate}%
              </span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-3 h-3 bg-yellow-400 rounded-full animate-pulse"></div>
              <span className="text-yellow-300">
                Expenses Growth: {projectionConfig.expensesGrowthRate}%
              </span>
            </div>
          </div>
          <p className="text-gray-400 text-xs mt-2">
            💡 These highlighted values drive the entire projection model.
            Adjust them in the configuration panel above.
          </p>
        </div>
      </CardHeader>
      <CardContent>
            ...
            <TableBody>
              ...
              <TableRow className="border-purple-500/20 hover:bg-purple-900/10">
                <TableCell className="text-cyan-400 font-mono text-xs font-bold sticky left-0 bg-gray-900/95 border-r border-purple-500/30 min-w-[180px] max-w-[220px]">
                  <TooltipInfo
                    text="Historical data based on data provided by US Department of the Treasury."
                    sourceLink="https://fiscaldata.treasury.gov/datasets/historical-debt-outstanding/historical-debt-outstanding"
                  >
              ...
              <TableRow>
                <TableCell
                  colSpan={projectionData.length + 1}
                  className="h-4"
                ></TableCell>
              </TableRow>
              ...
              <TableRow className="border-purple-500/20 hover:bg-purple-900/10">
                <TableCell className="text-green-400 font-mono text-xs font-bold sticky left-0 bg-gray-900/95 border-r border-purple-500/30 min-w-[180px] max-w-[220px]">
                  <TooltipInfo
                    text="Historical data based on data provided by US Department of the Treasury."
                    sourceLink="https://fiscaldata.treasury.gov/datasets/monthly-treasury-statement/summary-of-receipts-outlays-and-the-deficit-surplus-of-the-u-s-government"
                  >
              ...
              <TableRow className="border-purple-500/20 hover:bg-purple-900/10">
                <TableCell className="text-green-400 font-mono text-xs font-bold sticky left-0 bg-gray-900/95 border-r border-purple-500/30 min-w-[180px] max-w-[220px]">
                  YoY increase %{/* Highlight for projected assumptions */}
              ...
              <TableRow className="border-purple-500/20 hover:bg-purple-900/10">
                <TableCell className="text-red-400 font-mono text-xs font-bold sticky left-0 bg-gray-900/95 border-r border-purple-500/30 min-w-[180px] max-w-[220px]">
                  <TooltipInfo
                    text="Historical interest expense data from Federal Reserve Economic Data (FRED)."
                    sourceLink="https://fred.stlouisfed.org/series/FYOINT"
                  >
              ...
              <TableRow className="border-purple-500/20 hover:bg-purple-900/10">
                <TableCell className="text-white font-mono text-xs font-bold sticky left-0 bg-gray-900/95 border-r border-purple-500/30 min-w-[180px] max-w-[220px]">
                  Safe if Interest &lt; Total receipts. Bankrupt if Interest
                  &gt; Receipts
                </TableCell>
                {projectionData.map((data) => (
                  <TableCell
