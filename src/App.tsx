  ...
  return (
    <Provider store={store}>
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-black to-gray-800">
        <div className="flex-1 container mx-auto px-2 sm:px-4 py-4 sm:py-8 flex flex-col space-y-4 sm:space-y-8">
          <Hero />
          ...
          <div className="text-center">
            <div className="inline-block px-4 sm:px-8 py-4 sm:py-6 bg-gray-900/60 border-2 border-cyan-500/40 rounded-lg backdrop-blur-sm shadow-lg max-w-2xl mx-2 sm:mx-0">
              <div className="flex items-center justify-center space-x-3 mb-4">
                <div className="w-3 h-3 bg-cyan-500 rounded-full animate-pulse"></div>
                <h3 className="text-cyan-400 font-mono text-sm sm:text-lg font-bold uppercase tracking-wider">
                  📊 ADVANCED MODEL AVAILABLE
                </h3>
                <div className="w-3 h-3 bg-cyan-500 rounded-full animate-pulse"></div>
              </div>
              <div className="space-y-3">
                <p className="text-cyan-200 font-mono text-xs sm:text-sm">
                ...
                <a
                  ...
                  className="inline-flex items-center space-x-2 px-3 sm:px-4 py-2 bg-cyan-600 hover:bg-cyan-700 text-white border border-cyan-500 rounded-md font-mono text-xs sm:text-sm font-bold transition-all duration-200 hover:shadow-lg hover:shadow-cyan-500/25"
                >
                  <span>🔗 GOOGLE SHEETS</span>
                </a>
                <p className="text-cyan-300/80 font-mono text-xs sm:text-xs">
